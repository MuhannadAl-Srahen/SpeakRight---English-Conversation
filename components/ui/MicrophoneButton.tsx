...
const MicIcon: React.FC<{ listening: boolean }> = ({ listening }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={`h-8 w-8 sm:h-10 sm:w-10 ${listening ? 'text-red-500' : 'text-[#FFC107]'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const MicrophoneButton: React.FC<MicrophoneButtonProps> = ({
  ...
  return (
    <button
      ...
      className="relative flex items-center justify-center w-20 h-20 sm:w-24 sm:h-24 cursor-pointer disabled:cursor-not-allowed group transition-transform hover:scale-105 active:scale-95"
    ...
    >
      ...
      <div className="relative p-4 sm:p-5 bg-gradient-to-br from-[#1e293b] to-[#2B3855] rounded-full z-10 transition-all shadow-xl group-hover:shadow-2xl group-hover:from-[#2B3855] group-hover:to-[#394a6c] ring-2 ring-indigo-500/20">
