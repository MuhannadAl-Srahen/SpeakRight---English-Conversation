  ...
  return (
    <div className="space-y-6 animate-fade-in h-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* User Profile Card */}
        <div className="lg:col-span-1 bg-gradient-to-br from-slate-800 to-slate-900 rounded-3xl p-6 flex flex-col items-center justify-center text-center shadow-xl border border-slate-700/50 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-32 h-32 bg-amber-500/10 rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 left-0 w-24 h-24 bg-blue-500/10 rounded-full blur-2xl"></div>
          
          <div className="relative">
            <div className="w-32 h-32 rounded-full bg-gradient-to-br from-amber-400 to-orange-500 p-1 animate-pulse-slow">
              <img 
            ...
            <div className="absolute -bottom-2 -right-2 w-12 h-12 bg-gradient-to-br from-green-400 to-emerald-500 rounded-full flex items-center justify-center text-2xl shadow-lg border-4 border-slate-800">
              {getMoodEmoji(currentMood)}
            </div>
          </div>

          <h2 className="text-3xl font-bold mt-6 bg-gradient-to-r from-amber-400 to-orange-500 bg-clip-text text-transparent">
            {userName}
          </h2>
        ...
        <div className="lg:col-span-2 bg-gradient-to-br from-slate-800 to-slate-900 rounded-3xl p-6 shadow-xl border border-slate-700/50">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h2 className="text-2xl font-bold text-white">Learning Progress</h2>
              <p className="text-slate-400 text-sm mt-1">Your weekly performance</p>
            </div>
      ...
      <div 
        ...
        className="relative w-full h-64 rounded-3xl overflow-hidden group cursor-pointer shadow-2xl border border-slate-700/50 transform hover:scale-[1.02] transition-all duration-300"
      >
        <img 
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6">
          <div className="w-20 h-20 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
            <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
          </div>
          <h2 className="text-4xl font-bold text-white mb-2">Enter the Virtual World</h2>
          <p className="text-slate-300 text-lg">Practice English in real-life scenarios</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <button 
          ...
          className="group relative bg-gradient-to-br from-amber-400 to-orange-500 p-6 rounded-3xl shadow-xl flex items-center justify-between overflow-hidden hover:shadow-2xl hover:shadow-amber-500/50 transition-all duration-300 transform hover:scale-105"
        >
          ...
          <div className="flex items-center gap-4 z-10">
            ...
            <div className="text-left">
              <h3 className="text-2xl font-bold text-white">Dynamic Challenges</h3>
              <p className="text-white/80 text-sm mt-1">Practice with AI coach</p>
            </div>
          </div>
        ...
        <button 
          ...
          className="group relative bg-gradient-to-br from-slate-700 to-slate-800 p-6 rounded-3xl shadow-xl flex items-center justify-between border-2 border-slate-600/50 overflow-hidden hover:border-blue-500/50 hover:shadow-2xl hover:shadow-blue-500/30 transition-all duration-300 transform hover:scale-105"
        >
          ...
          <div className="flex items-center gap-4 z-10">
            <FriendsIcon />
            <div className="text-left">
              <h3 className="text-2xl font-bold text-white">Speak With Friends</h3>
              <p className="text-slate-400 text-sm mt-1">Share your progress</p>
            </div>
          </div>
