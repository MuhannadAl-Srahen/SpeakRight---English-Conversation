...
const LocationCard: React.FC<{ location: VirtualWorldLocation; onClick: () => void; index: number }> = ({ location, onClick, index }) => {
  ...
  return (
    <button 
      ...
      className="relative w-full h-72 rounded-3xl overflow-hidden group shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-[1.02] border border-slate-700/50"
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col justify-end p-6 space-y-3">
        {/* Icon Badge */}
        <div className={`w-14 h-14 bg-gradient-to-br from-amber-400 to-orange-500 rounded-2xl flex items-center justify-center shadow-lg transition-all duration-300 ${isHovered ? 'scale-110 rotate-6' : ''}`}>
    ...
    <div className="animate-fade-in space-y-8">
      ...
      <div className="text-center space-y-4 mb-12">
        <div className="flex justify-center mb-6">
          <div className="w-20 h-20 bg-gradient-to-br from-amber-400 to-orange-500 rounded-3xl flex items-center justify-center shadow-2xl shadow-amber-500/30 animate-pulse-slow">
